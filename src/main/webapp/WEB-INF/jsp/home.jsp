		...
		<div class="row mt-5">
			...
			<div class="col-md-10">
				...
				<c:if test="${page=='add' }">
					...
					<form:form action="/FirstSpringMvc/saveTodo" method="post" modelAttribute="todo">
						<div class="form-group">
							<form:input path="todoTitle" cssClass="form-control" placeholder="Enter your todo title"></form:input>
						</div>
						<div class="form-group">
							<form:textarea path="todoContent" cssClass="form-control" cssStyle="height:100px" placeholder="Enter your content" />
						</div>
